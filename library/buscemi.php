...
function buscemi_scripts() {
    ...
    wp_enqueue_style('buscemi_style', get_template_directory_uri() . '/css/main.min.css', null, null, null);
    wp_enqueue_script('buscemi_script', get_template_directory_uri() . '/static/min/site-min.js', array('jquery'), null, null, true);
}
